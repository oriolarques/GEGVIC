...
(https://software.broadinstitute.org/cancer/software/gsea/wiki/index.php/Data_formats). In the case of working with mouse data, gene symbols are automatically transformed to human orthologs so the same gene sets from MSigDB can be used. The *C7: Immunologic signature gene sets* was downloaded (**c7.all.v7.2.symbols.gmt** file) and used to create this example. 
